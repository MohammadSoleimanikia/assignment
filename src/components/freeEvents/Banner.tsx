export default function Banner() {
    return (
        <div className="relative w-full md:w-9/12 lg:w-7/12 md:mx-auto  py-10 flex items-center justify-center">
            {/* banner container */}
            <img alt="" className="absolute top-5 h-[90%] w-[80%]" src="/images/freeEvents/lines.png"  />
            <div
                className="
                ...
                "
            >
                <img alt="" src="/pattern.png" className="absolute top-0 left-0" />
                {/* right text */}
                <div className="relative text-right space-y-1 md:space-y-2">
                    ...
                    <img
                        className="w-56"
                        src="/images/freeEvents/free.svg"
                        alt=""
                    />
